...
public:
    BasisFunctions(){
        ...
        _base = "Lagrange";
        _C = 0;
        _numint = "GaussQuadrature";
    }

    BasisFunctions(str1& base){
        _base = base;
        _C = 0;
        _numint = "GaussQuadrature";
        _intsch = 1;
        ...
        else if(boost::iequals(_base,"LagrangeES") || boost::iequals(_base,"LagrangianES") ||
                boost::iequals(_base,"Lagrange ES"))
        {
            _choosebases = 2;
            _chooselag = 1;
        }
    ...
    BasisFunctions(str1 &base, int C){
        _base = base;
        _C = C;
        _numint = "GaussQuadrature";
        _intsch = 1;
    ...
    BasisFunctions(str1 &base, int C, str2 &numint){
        _base = base;
        _C = C;
        _numint = numint;
...
} // end of function BasesPointsWeights
