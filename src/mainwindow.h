...
private:
    ...
    QAction *newAct, *fullScreenAct, *wndResolutionAct, *exitAct, *aboutAct;
    QAction *gendetailsAct, *runStaticAct,*runModalAct,*runDynamicAct;

    QLabel *height_label, *width_label,*openFile_label;

    LabelInfo *infoLabel;

    QLabel *infoLabel_C, *infoLabel_n, *infoLabel_bases, *infoLabel_analysis, *infoLabel_dynint;
    QLabel *infoLabel_numint, *infoLabel_iso, *infoLabel_node_number;

    QLabel *C_label, *n_label, *analysis_label, *numint_label, *bases_label, *dynint_label;

    QLabel *x1_label, *x2_label, *x3_label, *shear_label, *infolabel_x1, *infolabel_x2;
    QLabel *infolabel_x3, *infolabel_shear, *infolabel_geom;

    QLabel *density_label, *mu_label, *lambda_label, *c33_label, *c34_label, *c35_label;
    QLabel *c44_label, *c45_label, *c55_label, *iso_label;

    QLabel *e11_label,*e12_label,*e13_label,*e21_label,*e22_label,*e23_label,*e31_label, *e32_label,*e33_label;

    QLabel *p11_Label,*p12_Label,*p13_Label,*p14_Label,*p15_Label,*p16_Label,*p21_Label,*p22_Label,*p23_Label;
    QLabel *p24_Label,*p25_Label,*p26_Label,*p31_Label,*p32_Label,*p33_Label,*p34_Label,*p35_Label,*p36_Label;
    ...
    QLineEdit *line_p11,*line_p12,*line_p13,*line_p14,*line_p15,*line_p16,*line_p21,*line_p22,*line_p23;
    QLineEdit *line_p24,*line_p25,*line_p26,*line_p31,*line_p32,*line_p33,*line_p34,*line_p35,*line_p36;
    ...
    QLabel *static_plot_index_label,*modal_plot_index_label, *dynamic_plot_step_index_label;
    QLabel *dynamic_plot_var_index_label;
