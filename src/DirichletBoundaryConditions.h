...
void DirichletBoundaryConditions(Eigen::SparseMatrix<double, Eigen::ColMajor>& stiffg, Eigen::VectorXd& F,
                                 Eigen::Matrix<double, Eigen::Dynamic, 3>& Dirichlet_Boundary_Conditions);

void DirichletBoundaryConditions(Eigen::Matrix<double,Eigen::Dynamic,3>& Dirichlet_Boundary_Conditions,
                                 Eigen::MatrixXi &conc,Eigen::MatrixXd &Dirichlet_data);
